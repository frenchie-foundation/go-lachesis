	...
	g := Genesis{
		...
		Alloc: VAccounts{
			Accounts: Accounts{
				...
				common.HexToAddress("0xe9f77B989E3a73ed24D0467fAA9300Ab94477915"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0x7f9d1dbaf84d827b0840e38f555a490969978d20"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0xfd09f0296af88ac777c137ecd92d85583a9b9e4a"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0x520D07E2F0F3f60b7510e65a291862976a9547c6"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0x93194b30FA85D1927852769bAB1822dD2B6818e1"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0xc73b84eac512a04f139D4a200aAe0FF24c4A5cBC"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0xd160D9B59508e4636eEc3E0a7f734268D1cE1047"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0x03894D86CC6e1E41e8bBa17469204D304C4e92b8"): Account{Balance: utils.ToFren(100)},
				common.HexToAddress("0x51AF0532E6BD89695266E714a1B09fD1Ac297DC7"): Account{Balance: utils.ToFren(100)},
			},
