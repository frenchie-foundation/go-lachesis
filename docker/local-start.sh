...
do
	...
	--port=${PORT} \
	--http --http.addr="127.0.0.1" --http.port=${RPCP} --http.corsdomain="*" --http.api="eth,debug,admin,web3,personal,txpool,fren,sfc" \
	--ws --ws.addr="127.0.0.1" --ws.port=${WSP} --ws.origins="*" --ws.api="eth,debug,admin,web3,personal,txpool,fren,sfc" \
